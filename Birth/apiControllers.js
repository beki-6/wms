...
const updateBirth = async (req, res) => {
  if (req.body.nameOfChild != null) {
    res.birth.nameOfChild = req.body.nameOfChild;
  }
  if (req.body.sex != null) {
    res.birth.sex = req.body.sex;
  }
  if (req.body.dateOfBirth != null) {
    res.birth.fatherName = req.body.dateOfBirth;
  }
  if (req.body.placeOfBirth != null) {
    res.birth.placeOfBirth = req.body.placeOfBirth;
  }
  if (req.body.deliveryMethod != null) {
    res.birth.deliveryMethod = req.body.deliveryMethod;
  }
  if (req.body.nationality != null) {
    res.birth.nationality = req.body.nationality;
  }
  if (req.body.weight != null) {
    res.birth.weight = req.body.weight;
  }
  if (req.body.attendantProfessional != null) {
    res.birth.attendantProfessional = req.body.attendantProfessional;
  }
  if (req.body.motherResidentInfo != null) {
    res.birth.motherResidentInfo = req.body.motherResidentInfo;
  }
  if (req.body.fatherResidentInfo != null) {
    res.birth.fatherResidentInfo = req.body.fatherResidentInfo;
  }
  try {
  ...
  try {
    ...
    if (birth == null) {
      res
        .status(404)
        .json({
          message: "birth certificate with the specified Id doesn't exist.",
        });
    }
  } catch (err) {
