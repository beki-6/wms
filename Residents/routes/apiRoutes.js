...
//GET a resident
router.get('/resident/:id', controllers.getResidentByID, controllers.getOneResident);
//UPDATE a resident
router.patch('/resident/:id', controllers.getResidentByID, controllers.updateResident);
//DELETE a resident
